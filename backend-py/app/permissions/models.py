...
PERM_CRUDL = PERM_TO_CREATE_ENTITY | PERM_TO_READ_ENTITY | PERM_TO_UPDATE_ENTITY| PERM_TO_DELETE_ENTITY | PERM_TO_LIST_ENTITIES
PERM_CRUDL_ANOTHER = PERM_TO_LIST_ENTITIES | PERM_TO_READ_ANOTHER_USER_S_ENTITY | PERM_TO_UPDATE_ANOTHER_USER_S_ENTITY | PERM_TO_DELETE_ANOTHER_USER_S_ENTITY | PERM_TO_LIST_OTHER_USERS_ENTITIES
