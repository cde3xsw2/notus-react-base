...
export function ProductStateIcon() {
  return (
    <svg
      aria-hidden="true"
      class="mr-1 w-3 h-3"
...
export const UploadImagenIcon2 = (
  <svg
    aria-hidden="true"
