...
function Row({name,image,category,stock,salesDay,salesMonth,rating,sales,revenue}) {
  ...
  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{salesDay}</td>
  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{salesMonth}</td>
  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
      <div class="flex items-center">
