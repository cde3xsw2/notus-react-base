...
{/*  transform-none
-translate-x-full */}
<div id="drawer-read-product-advanced" class={`overflow-y-auto fixed top-0 left-0 z-40 p-4 w-full max-w-lg h-screen bg-white transition-transform ${false ? 'transform-none' : '-translate-x-full' } dark:bg-gray-800`} tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    <div>
...
{editing && <div drawer-backdrop="" class="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30"></div>}
...
function Row({name,image,category,stock,salesDay,salesMonth,rating,sales,revenue}) {
